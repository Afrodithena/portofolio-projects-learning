...
├── 📁 phase-6-portal/ # RAG + LLM peonalization portal 
└── README.md
...
|------|-------|------------|--------|
| 1 | **Foundation** | Python OOP, Logging, Type Hints | 🟡 In Progress |
| 2 | **Customer Churn** | Scikit-learn, XGBoost, Feature Engineering | 🟡 In Progress |
| 3 | **Pricing & Bundling** | Market Basket Analysis, Price Elasticity | 🟡 In Progress |
